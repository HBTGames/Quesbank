...
<html lang="en">
   ...
   <body onload="loadLanguage(); loadRecentUpdateText(8);">
         ...
         <div id="sepmanagepage">
            ...
            <div id="sentence_transtable">
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <!-- <?php
                              if (isset($_GET['idd'])){
                              $idd = $_GET['idd'];
                              $res = mysql_query("DELETE FROM test.sentence_trans WHERE idnew_table='$idd'");
               ...
               <?php
                  ...
                  $iddd = $_POST['idd'];
                  $res = mysql_query("DELETE FROM test.sentence_trans WHERE idsentence_trans='$iddd'");
                  mysql_query(" ALTER TABLE test.sentence_trans DROP `idsentence_trans`");
                  mysql_query("ALTER TABLE test.sentence_trans  AUTO_INCREMENT = 1");
                  mysql_query("ALTER TABLE test.sentence_trans  ADD `idsentence_trans` int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST");
                  if(! $res){
      ...
      <!--
         ...
         var idsentence_trans = $(this).attr("id");
         $.ajax({
         url:"fetch.php",
         method: "POST",
         data:{idsentence_trans:idsentence_trans},
         dataType:"json",
         ...
         $('#date').val(data.date);
         $('#idsentence_trans').val(data.idsentence_trans);
         $('#insert').val("Update");
         $('#myModal').modal('show');
         }
