...
<html lang="en">
   ...
   <body onload="loadLanguage(); loadRecentUpdateText(9);">
      <div class="container-narrow">
       ...
       <hr>
       <h1 class="managepagetitle lang" key="translationTag">Manage Translation</h1><br>
                  ...
                  <div id="translationtable">
                     <?php
                        $db = mysql_connect('localhost','root','password')
                         ...
                         $sql = "SELECT * FROM test.translation";
                     ...
                     <?php
                        $count = "SELECT COUNT(idtranslation) FROM test.translation";
                           ...
                           <tr>
                              ...
                              <hr>
                                 ...
                                 <!-- <?php
                                    if (isset($_GET['idd'])){
                                    $idd = $_GET['idd'];
                                    $res = mysql_query("DELETE FROM test.translation WHERE idnew_table='$idd'");
                     ...
                     <?php
                        ...
                        $iddd = $_POST['idd'];
                        $res = mysql_query("DELETE FROM test.translation WHERE idtranslation='$iddd'");
                        mysql_query(" ALTER TABLE test.translation DROP `idtranslation`");
                        mysql_query("ALTER TABLE test.translation  AUTO_INCREMENT = 1");
                        mysql_query("ALTER TABLE test.translation  ADD `idtranslation` int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST");
                        if(! $res){
                        die('Could not update data: ' . mysql_error());
                        }
                        echo "Updated data successfully\n";
                        echo '<script> window.location.href="managetranslation.php"; </script>';
                        }
                           ?>
                     <?php
      ...
      <!--
         ...
         var idtranslation = $(this).attr("id");
         $.ajax({
         url:"fetch.php",
         method: "POST",
         data:{idtranslation:idtranslation},
         dataType:"json",
         ...
         $('#date').val(data.date);
         $('#idtranslation').val(data.idtranslation);
         $('#insert').val("Update");
         $('#myModal').modal('show');
         }
