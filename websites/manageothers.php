...
<html lang="en">
   ...
   <body onload="loadLanguage(); loadRecentUpdateText(4);">
       ...
       <h1 class="managepagetitle lang" key="othersTag">Manage Others</h1><br>
                  ...
                  <div id="otherstable">
                           ...
                           <tr>
                              ...
                              <hr>
                                 ...
                                 <!-- <?php
                                    if (isset($_GET['idd'])){
                                    $idd = $_GET['idd'];
                                    $res = mysql_query("DELETE FROM test.others WHERE idnew_table='$idd'");
                     ...
                     <?php
                        ...
                        $iddd = $_POST['idd'];
                        $res = mysql_query("DELETE FROM test.others WHERE idothers='$iddd'");
                        mysql_query(" ALTER TABLE test.others DROP `idothers`");
                        mysql_query("ALTER TABLE test.others  AUTO_INCREMENT = 1");
                        mysql_query("ALTER TABLE test.others  ADD `idothers` int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST");
                        if(! $res){
                        die('Could not update data: ' . mysql_error());
                        }
                        echo "Updated data successfully\n";
                        echo '<script> window.location.href="manageothers.php"; </script>';
                        }
                           ?>
                     <?php
      ...
      <!--
         ...
         var idothers = $(this).attr("id");
         $.ajax({
         url:"fetch.php",
         method: "POST",
         data:{idothers:idothers},
         dataType:"json",
